...
/**
 * 适应状态栏高度的{@link LinearLayout}，并且能兼容
 *
 * @author ZhangXiaoMing 2024-04-14 21:49 周日
 */
public class XMFitsSystemLinearLayout extends LinearLayout {

    private static final String TAG = "XMFitsSystemLinearLayout";

    private final int[] mInsets = new int[4];

    public XMFitsSystemLinearLayout(@NonNull Context context) {
        this(context, null);
    }

    public XMFitsSystemLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XMFitsSystemLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray array = c.obtainStyledAttributes(attrs, R.styleable.XMFitsSystemLinearLayout);
            fitsSystemStyle = array.getInteger(R.styleable.XMFitsSystemLinearLayout_fitsSystemStyle, FitsSystemStyle.NONE);
            array.recycle();
        }
