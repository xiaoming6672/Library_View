...
/**
 * 适应状态栏高度的{@link RelativeLayout}，并且能兼容
 *
 * @author ZhangXiaoMing 2024-04-14 21:49 周日
 */
public class XMFitsSystemRelativeLayout extends RelativeLayout {

    private static final String TAG = "XMFitsSystemRelativeLayout";

    private final int[] mInsets = new int[4];

    public XMFitsSystemRelativeLayout(@NonNull Context context) {
        this(context, null);
    }

    public XMFitsSystemRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XMFitsSystemRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    public static class LayoutParams extends RelativeLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray array = c.obtainStyledAttributes(attrs, R.styleable.XMFitsSystemRelativeLayout);
