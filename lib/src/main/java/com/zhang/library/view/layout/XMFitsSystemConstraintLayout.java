...
/**
 * 适应状态栏高度的{@link ConstraintLayout}，并且能兼容
 *
 * @author ZhangXiaoMing 2024-04-14 21:49 周日
 */
public class XMFitsSystemConstraintLayout extends ConstraintLayout {

    private static final String TAG = "XMFitsSystemConstraintLayout";

    private final int[] mInsets = new int[4];

    public XMFitsSystemConstraintLayout(@NonNull Context context) {
        this(context, null);
    }

    public XMFitsSystemConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XMFitsSystemConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    public static class LayoutParams extends ConstraintLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray array = c.obtainStyledAttributes(attrs, R.styleable.XMFitsSystemConstraintLayout);
            fitsSystemStyle = array.getInteger(R.styleable.XMFitsSystemConstraintLayout_fitsSystemStyle, FitsSystemStyle.NONE);
            array.recycle();
        }
