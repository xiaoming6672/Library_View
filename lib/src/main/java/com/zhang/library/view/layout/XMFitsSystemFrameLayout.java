...
public class XMFitsSystemFrameLayout extends FrameLayout {
    ...
    public XMFitsSystemFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XMFitsSystemFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
